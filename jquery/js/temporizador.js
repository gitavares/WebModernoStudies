(function ($){
    $.fn.temporizador = function (opcoes) {
        const opcoesFinais = $.extend({
            mensagem: 'Em breve!',  //caso o usuário não tenha informado esses dois valores padrões, esse retornos serão utilizados. caso o usuário passe, isso será substituído
            horario: '23:59:59'
        }, opcoes)
