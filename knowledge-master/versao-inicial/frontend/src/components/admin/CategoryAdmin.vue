    ...
    <div class="category-admin">
        <b-form>
            ...
            <b-form-group label="Name:" label-for="category-name">
                <b-form-input id="category-name" type="text" v-model="category.name" required placeholder="Category Name" :readonly="mode === 'remove'" />
            </b-form-group>
            <b-form-group label="Parent:" label-for="category-parentId">
