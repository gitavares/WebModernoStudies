    ...
    <div class="article-admin">
        <b-form>
            ...
            <b-form-group label="Name:" label-for="article-name">
                <b-form-input id="article-name" type="text" v-model="article.name" required placeholder="Article Name" :readonly="mode === 'remove'" />
            </b-form-group>
            <b-form-group label="Description:" label-for="article-description">
                <b-form-input id="article-description" type="text" v-model="article.description" required placeholder="Article Description" :readonly="mode === 'remove'" />
            </b-form-group>
            <b-form-group label="Image (URL):" label-for="article-imageUrl" v-if="mode === 'save'">
                <b-form-input id="article-imageUrl" type="text" v-model="article.imageUrl" required placeholder="Article Image URL" :readonly="mode === 'remove'" />
            </b-form-group>
            ...
            <b-form-group label="Content:" label-for="article-content" v-if="mode === 'save'">
                <VueEditor id="article-content" v-model="article.content" placeholder="Article Content" />
            </b-form-group>
